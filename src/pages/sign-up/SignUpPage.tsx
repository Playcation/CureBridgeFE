...
const SignupPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const fileToSend = profileImage || new File([""], "empty.jpg", {type: "image/jpeg"});
      formDataToSend.append('profile', fileToSend);
          ...
          <form className={styles.form} onSubmit={handleSubmit}>
            ...
            <div className={styles.profileSection}>
              ...
              <input
                  ...
                  style={{display: 'none'}}
              />
              <span className={styles.profileLabel}>프로필 사진을 등록해주세요</span>
            </div>
            {/* 이름 / 성별 */}
            ...
            <div className={styles.inputGroup}>
              ...
              <div className={styles.passwordInputWrapper}>
                <input type={showPassword ? 'text' : 'password'} id="password" name="password"
                       placeholder="비밀번호를 입력하세요." className={styles.passwordInput}
            ...
            <div className={styles.inputGroup}>
              ...
              <div className={styles.passwordInputWrapper}>
                <input type={showPasswordConfirm ? 'text' : 'password'} id="passwordConfirm"
                       name="passwordConfirm" placeholder="비밀번호를 다시 입력하세요."
                       className={styles.passwordInput} onChange={handleChange}/>
                <img src={EyeIcon} alt="show password confirm" className={styles.eyeIcon}
