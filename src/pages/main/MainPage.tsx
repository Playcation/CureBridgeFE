        ...
        <div className={styles.pageWrapper}>
            <section className={styles.heroSection}>
                ...
                <div className={styles.ctaColumn}>
                    ...
                    <button
                        ...
                        onClick={() => navigate("/insurance-check")}
                    >
                        <span>국민 건강 보험 적용 여부 확인하기</span>
                        <span className={styles.ctaIcon}>➜</span>
                    </button>
                </div>
            </section>
            ...
            <section className={styles.featuresSection}>
                ...
                <div className={styles.cardsRow}>
                    {/* 카드 1 */}
                    <button className={styles.card} onClick={() => navigate("/ocr")}>
              ...
              <span className={styles.cardTitle}>
                ...
                결과 조회하기
                        ...
                        <p className={styles.cardDesc}>
                            진단서를 업로드하면 AI가 내용을 인식하고, 필요한 핵심 정보를 자동으로 정리해 보여줍니다.
                        </p>
                    </button>
                    ...
                    <button className={styles.card} onClick={() => navigate("/news")}>
                        ...
                        <p className={styles.cardDesc}>
                            최신 의학 뉴스와 연구 정보를 모아, 내 건강 상태와 연관된 정보를 빠르게 확인할 수 있어요.
                        </p>
                    </button>

                    {/* 카드 3 */}
                    <button className={styles.card} onClick={() => navigate("/chat")}>
                        <div className={styles.cardTop}>
                        ...
                        <p className={styles.cardDesc}>
                            궁금한 점을 전문가에게 실시간으로 질문하고, 필요한 경우 상담을 이어갈 수 있습니다.
                        </p>
                    </button>
                </div>
            </section>
            ...
            <section className={styles.infoSection}>
                <div className={styles.infoTitleArea}>
                    ...
                    <p className={styles.infoSub}>
                        진단서 업로드부터 보험 적용 확인까지, 세 단계면 충분해요.
                    </p>
                </div>
                ...
                <div className={styles.stepsGrid}>
                    <div className={styles.stepCard}>
                        ...
                        <p className={styles.stepDesc}>
                            병원에서 받은 진단서를 사진이나 PDF로 업로드하면 OCR이 자동으로 내용을 인식해요.
                        </p>
                    </div>
                    ...
                    <div className={styles.stepCard}>
                        ...
                        <p className={styles.stepDesc}>
                            진단 내용과 검사 결과를 바탕으로 현재 상태와 주의해야 할 부분을 한눈에 보여드립니다.
                        </p>
                    </div>

                    <div className={styles.stepCard}>
                        <span className={styles.stepBadge}>STEP 3</span>
                        <h3 className={styles.stepTitle}>보험 적용 여부·상담 연결</h3>
                        <p className={styles.stepDesc}>
                            국민건강보험 적용 여부를 확인하고, 필요한 경우 전문가와의 실시간 상담까지 이어갈 수 있어요.
                        </p>
                    </div>
                </div>
